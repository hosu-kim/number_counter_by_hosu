...
// implements(class keyword): Follows CounterInterface requirements
export class Counter implements CounterInterface {
	// Class member declaration: In Python, self.name (instance attributes/variables)
	// private: Access modifier; Restricts access to the class member to only within the class itself
	...
	*/
	// public: Allows access to the class member from anywhere, both inside and outside the class
	public init(): void {
